class AlternativesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @alternative.save
        format.html { redirect_to @alternative, notice: 'Alternativa creada con éxito.' }
  ...
  def update
    respond_to do |format|
      if @alternative.update(alternative_params)
        format.html { redirect_to @alternative, notice: 'Alternativa actualizada con éxito.' }
  ...
  def destroy
    @alternative.destroy
    respond_to do |format|
      format.html { redirect_to alternatives_url, notice: 'Alternativa borrada con éxito.' }
  ...
  private
    ...
    def alternative_params
      params.require(:alternative).permit(:texto, :correcta, :question_id)
    end
end
