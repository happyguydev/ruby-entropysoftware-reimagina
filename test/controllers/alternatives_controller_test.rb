...
class AlternativesControllerTest < ActionController::TestCase
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post :create, alternative: { correcta: @alternative.correcta, question_id: @alternative.question_id, texto: @alternative.texto }
    end
  ...
  test "should update alternative" do
    patch :update, id: @alternative, alternative: { correcta: @alternative.correcta, question_id: @alternative.question_id, texto: @alternative.texto }
    assert_redirected_to alternative_path(assigns(:alternative))
  end
