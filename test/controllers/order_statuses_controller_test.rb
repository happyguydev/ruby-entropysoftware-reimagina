...
class OrderStatusesControllerTest < ActionController::TestCase
  ...
  test "should create order_status" do
    assert_difference('OrderStatus.count') do
      post :create, order_status: { comentario: @order_status.comentario, order_id: @order_status.order_id, status_type_id: @order_status.status_type_id }
    end
  ...
  test "should update order_status" do
    patch :update, id: @order_status, order_status: { comentario: @order_status.comentario, order_id: @order_status.order_id, status_type_id: @order_status.status_type_id }
    assert_redirected_to order_status_path(assigns(:order_status))
  end
